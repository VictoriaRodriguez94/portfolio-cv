...
<?php include_once("header.php");?>
    ...
    <main class="container">
        ...
        <div class="row">
            <div class="col-sm-6 col-12 mt-4">
                ...
                <p>Desarrolladora Front End y Diseñadora Gráfica. Me gusta combinar lo mejor de mis dos mundos.
                    Descubrí que me apasiona maquetar, crear cosas nuevas y curiosear por lo que estoy abierta a nuevos
                    desafíos.

                    Actualmente me desempeño en el puesto de Soporte, un rol multifuncional relacionado con el
                    desarrollo de sitios eCommerce.</p>
    ...
    <!-- PRIMER FILA DE STACK-->


    <section class="color-rojo mt-5">
        <div class="container stack-tecnologico">
            <div class="row">
                <h2 class="col-12 mt-5 mb-5"> Stack Tecnologico</h2>
            </div>
            ...
            <!-- COMIENZA LA OTRA FILA DE STACK-->
        ...
        <div class="row shadow bg-white rounded">
            ...
            <div class="col-12">
                ...
                <div class="row">
                    ...
                    <div class="col-12- col-sm-10 p-3">
                        ...
                        <h4>Wuala</h4>
                        <h5> Marzo 2021 - Presente </h5>
                        <p>Me desempeño realizando tareas de
                            soporte web y diseño en el área de soporte
                            implementación eCommerce para
                            diferentes tiendas webs a través de la
            ...
            <div class="row">
                ...
                <div class="col-12- col-sm-10 p-3">
                    ...
                    <h4>Vivivenda Verde</h4>
                    <h5>Enero 2021 - Marzo </h5>
                    <p> Desarrollo de sitio web Ecommerce a
                        través de Magento para una empresa de
                        construcción. Planificación del proyecto
                        Tecnopor y maquetación del mismo.
                        https://tecnopor.tiendaweb.app/ </p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="col-12 col-sm-6">
                <div class="row">
                    ...
                    <div class="col-12- col-sm-10 p-3">
                        ...
                        <h4>Bachillerato en Ciencias Sociales y Humanidades</h4>
                        <h5>2006 – 2011</h5>
                        <p>https://institucionescuti.edu.ar/<br>
                        </p>
                    </div>
                </div>
            </div>
    ...
    <section class="container mb-5" id="educacion"> 
        <div class="row">
            <div class="col-12 pt-5 pb-4">
        ...
        <div class="row shadow bg-white rounded p-1">
            <div class="col-12 col-sm-6">
                <div class="row">
                    ...
                    <div class="col-12- col-sm-10 p-3">
                        <h3>DePC Suite</h3>
                        <h4>Desarrollo Full Stack PHP</h4>
                        <h5>Junio 2021 - En Curso</h5>
                        <p></p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6">
                <div class="row">
                    ...
                    <div class="col-12- col-sm-10 p-3">
                        ...
                        <h4>Coder House</h4>
                        <h5>Expedición: Noviembre 2020</h5>
                        <p></p>
                    </div>
                </div>
            </div>
...
<script src="https://kit.fontawesome.com/5d84778086.js" crossorigin="anonymous"></script>
